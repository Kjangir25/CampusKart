    ...
    <div className="page home-page">
      <section className="hero-section">
        <div className="hero-copy">
          ...
          <p>
            Affordable books, electronics, essentials and more, traded by
          ...
          <div className="hero-buttons">
            ...
            <button className="secondary-button" onClick={() => go("sell")}>
              List an Item
              <span>+</span>
            </button>
          </div>
        ...
        <div className="hero-art">
          ...
          <div className="hero-laptop">
            <Laptop size={92} strokeWidth={1.2} />
          </div>
          ...
          <div className="floating-headphones">
            <Headphones size={56} />
          </div>
        </div>
      </section>
      ...
      <section className="home-section">
        <div className="section-heading">
          <div>
            <span className="eyebrow">Explore the campus market</span>
      ...
      <section className="sell-banner card">
        <div>
          <span className="eyebrow">Have something to sell?</span>
          <h2>Turn unused stuff into campus cash.</h2>
          <p>
            List your item in under two minutes and reach students around you.
          </p>
        </div>

        <button className="primary-button" onClick={() => go("sell")}>
          Start Selling
          <ArrowRight size={18} />
        </button>
      </section>
